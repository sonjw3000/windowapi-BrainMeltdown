...
void Player::input(float fDeltaTime)
{
	...
	if (m_bFalling){
		Move(0.0, m_bJumpSpeed * fDeltaTime);

		m_bJumpSpeed += 500 * fDeltaTime * 3;
...
void Player::render(HDC hdc)
{
	...
	m_tImg.TransparentBlt(hdc, t.left, t.top, 25, 50, m_iImageSprite * 57, 69 * (m_eMoveDir == MOVE_DIR::MD_FRONT ? 0 : 1), 57, 69, RGB(80, 40, 0));
